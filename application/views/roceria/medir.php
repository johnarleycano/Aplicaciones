...
<input type="text" id="abscisa_final" value="<?php echo $abscisa; ?>">
...
<script type="text/javascript">
	...
	function siguiente()
	{
        ...
        $("input[name^='calificacion_']:checked").each(function() {
        	var medicion = {
        		"Abscisa": $("#abscisa").val(),
        		"Fk_Id_Temp_Medicion": $("#id_medicion_temporal").val(),
	    ...
	    datos = {
	    	"tipo": "medicion_temporal",
	    	"id_medicion_temporal": $("#id_medicion_temporal").val(),
			"posicion": posicion,
			"abscisa": abscisa,
	    }
		...
		// Se carga la interfaz de medición
		cargar_interfaz("contenedor_principal", "<?php echo site_url('roceria/cargar_interfaz'); ?>", datos);
	}
