...
<div class="uk-form-controls">
	<input class="uk-range" type="range" id="rango_abscisado" value="<?php echo $abscisa_inicial; ?>" min="<?php echo $abscisa_inicial; ?>" max="<?php echo $abscisa_final; ?>" step="1000" title="Elija la abscisa donde iniciará el recorrido" uk-tooltip="pos: bottom-left">
</div>
...
<div class="uk-form-controls">
	...
	<div class="uk-align-right" id="rango">
		<?php echo (isset($via->Abscisa_Final) ? $this->configuracion_model->obtener("abscisado", $abscisa_inicial) : ""); ?>
	</div>
</div>
<div class="clear"></div>
